...
class QueuePopup(QMenu):
    ...
    def __init__(self, supports_batch=True, parent: QWidget | None = None):
        ...
        self._use_smart_resolution = QCheckBox(_("Smart Resolution"), self)
        self._resolution_smart_rotate = QCheckBox(_("Smart Rotate"), self)
        self._use_smart_resolution.toggled.connect(self._set_use_smart_resolution)
    ...
    def model(self, model: DocumentModel):
        ...
        self._connections = [
            ...
            model.use_smart_resolution_changed.connect(self._update_resolution_multiplier),
...
class GenerateButton(QPushButton):
    ...
    def paintEvent(self, a0: QPaintEvent | None) -> None:
        ...
        if is_hover and (not self.model.use_smart_resolution or self.model.smart_rotate):
